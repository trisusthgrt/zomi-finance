...
import {
    useVisualElement
} from './utils/use-visual-element.js';
import {
    useMotionRef
} from './utils/use-motion-ref.js';
import {
    useCreateMotionContext
} from '../context/MotionContext/create.js';
import {
    loadFeatures
} from './features/definitions.js';
import {
    isBrowser
} from '../utils/is-browser.js';
    ...
    function MotionComponent(props, externalRef) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(MotionContext.Provider, {
                value: context
            }, useRender(Component, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic)),
            features));
    }
