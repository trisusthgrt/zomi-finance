...
function Referrals({
    ...
    const {
        data: referralsData,
        loading
    } = useReferralsData(chainId, account);
    ...
    function renderAffiliatesTab() {
        ...
        if (isReferralCodeAvailable) {
            ...
            return ( <
                AddAffiliateCode handleCreateReferralCode = {
                    handleCreateReferralCode
                }
                active = {
                    active
    ...
    function renderTradersTab() {
        ...
        if (isHashZero(userReferralCode) || !account || !userReferralCode) {
            return ( <
                JoinReferralCode connectWallet = {
                    connectWallet
                }
                active = {
                    active
        ...
        return ( <
            TradersStats userReferralCodeString = {
                userReferralCodeString
            }
            chainId = {
                chainId
    ...
    return ( <
        ...
        <
        Trans >
        Get fee discounts and earn rebates through the $ZOMI referral program.For more information, please read the {
            " "
        } <
