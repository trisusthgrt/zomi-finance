...
function StakeModal(props) {
    ...
    return ( <
        ...
        <
        Trans > Max: {
            formatAmount(maxAmount, 18, 4, true)
        } < /Trans> <
        /div> <
        /div> <
    ...
    return ( <
        ...
        /div> {
            reservedAmount && reservedAmount.gt(0) && ( <
                ...
                You have {
                    formatAmount(reservedAmount, 18, 2, true)
                }
                tokens reserved
                for vesting. <
                /div>
            ...
            burnAmount && burnAmount.gt(0) && rewardReductionBasisPoints && rewardReductionBasisPoints.gt(0) && ( <
                div className = "Modal-note" >
                Unstaking will burn & nbsp; <
                a href = "https://docs.zomi.financerewards"
                target = "_blank"
                rel = "noopener noreferrer" > {
                    formatAmount(burnAmount, 18, 4, true)
                }
                Multiplier Points <
                /a>
                . & nbsp; {
                    shouldShowReductionAmount && ( <
                        span > Boost Percentage: -{
                            formatAmount(rewardReductionBasisPoints, 2, 2)
                        } % . < /span>
                    )
                } <
                /div>
...
function VesterDepositModal(props) {
    ...
    return ( <
        ...
        div className = "align-right" > {
            formatAmount(balance, 18, 2, true)
        }
        esZOMI < /div> <
        /div> <
        div className = "Exchange-info-row" >
        ...
        <
        Tooltip handle = {
            `${formatAmount(nextDepositAmount, 18, 2, true)} / ${formatAmount(
                    maxVestableAmount,
                    18,
                    2,
                    true
        ...
        renderContent = {
            () => {
                return ( <
                    ...
                    <
                    Trans > Vault Capacity
                    for your Account: < /Trans> <
                    /p> <
                    StatsTooltipRow showDollar = {
                        false
                    }
                    label = {
                        t `Deposited`
                    ...
                    value = {
                        `${formatAmount(vestedAmount, 18, 2, true)} esZOMI`
                    }
                    /> <
                    StatsTooltipRow showDollar = {
                        false
                    ...
                    value = {
                        `${formatAmount(maxVestableAmount, 18, 2, true)} esZOMI`
                    }
                    /> <
                    /div>
                );
        ...
        renderContent = {
            () => {
                return ( <
                    >
                    <
                    StatsTooltipRow label = {
                        t `Current Reserved`
                    }
                    value = {
                        formatAmount(reserveAmount, 18, 2, true)
                    }
                    showDollar = {
                        false
                    }
                    /> <
                    StatsTooltipRow label = {
                        t `Additional reserve required`
                    }
                    value = {
                        formatAmount(additionalReserveAmount, 18, 2, true)
                    }
                    showDollar = {
                        false
                    }
                    /> {
                        amount && nextReserveAmount.gt(maxReserveAmount) && ( <
                            ...
                            You need a total of at least {
                                formatAmount(nextReserveAmount, 18, 2, true)
                            } {
                                " "
                            } {
                                stakeTokenLabel
...
function VesterWithdrawModal(props) {
    ...
    return ( <
        ...
        <
        br / >
        To claim $ZOMI tokens without withdrawing, use the "Claim"
        button under the Total Rewards section. <
        br / >
        <
        br / >
        <
...
function CompoundModal(props) {
    ...
    return ( <
        ...
        setIsChecked = {
            setShouldStakeMultiplierPoints
        }
        disabled = {
            true
        } >
...
export default function StakeV2({
    ...
    const {
        data: aums
    } = useSWR([`StakeV2:getAums:${active}`, chainId, glpManagerAddress, "getAums"], {
    ...
    const {
        data: gmxSupply
    } = useSWR([`StakeV2:gmxSupply:${active}`, chainId, gmxAddress, "balanceOf", account], {
        fetcher: contractFetcher(library, Token),
    });
        ...
        return ( <
            ...
            renderContent = {
                () => {
                    return ( <
                        Trans >
                        Boost your rewards with Multiplier Points. & nbsp; <
                        a href = "https://docs.zomi.financerewards#multiplier-points"
                        rel = "noreferrer"
                        target = "_blank" >
                        More info <
                        /a>
    ...
    if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
        ...
        earnMsg = ( <
            ...
            rewards with {
                formatAmount(totalRewardTokensAndGlp, 18, 2, true)
            }
            tokens. <
            br / >
            Tokens: {
    ...
    return ( <
        ...
        maxAmount = {
            unstakeModalMaxAmount
        }
        reservedAmount = {
            unstakeModalReservedAmount
        }
        value = {
            unstakeValue
        }
        ...
        /> <
        VesterDepositModal isVisible = {
            isVesterDepositModalVisible
        }
        setIsVisible = {
        ...
        stakeTokenLabel = {
            vesterDepositStakeTokenLabel
        }
        maxAmount = {
            vesterDepositMaxAmount
        }
        balance = {
            vesterDepositBalance
        }
        escrowedBalance = {
            vesterDepositEscrowedBalance
        }
        vestedAmount = {
            vesterDepositVestedAmount
        }
        averageStakedAmount = {
        ...
        vesterAddress = {
            vesterDepositAddress
        }
        setPendingTxns = {
            setPendingTxns
        }
        /> <
        VesterWithdrawModal isVisible = {
            isVesterWithdrawModalVisible
        }
        setIsVisible = {
            setIsVesterWithdrawModalVisible
        }
        vesterAddress = {
            vesterWithdrawAddress
        }
        chainId = {
            chainId
        }
        ...
        isVisible = {
            isCompoundModalVisible
        }
        setIsVisible = {
            setIsCompoundModalVisible
        }
        rewardRouterAddress = {
            rewardRouterAddress
        }
        ...
        /div> {
            earnMsg && < div className = "Page-description" > {
                    earnMsg
                } < /div>} <
                /div> <
                /div> <
                    ...
                    gmxPrice && ( <
                        ...
                        renderContent = {
                            () => ( <
                                ...
                                <
                                StatsTooltipRow label = {
                                    t `Price on Avalanche`
                                }
                                value = {
                                    formatAmount(gmxPriceFromAvalanche, USD_DECIMALS, 2, true)
                                }
                                /> {
                                    /* <StatsTooltipRow
            ...
            $ZOMI($ {
                ...
                /div> <
                div > {
                    formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)
                }
            $ZOMI($ {
                ...
                Tooltip
            handle = {
                `${formatKeyAmount(processedData, "gmxAprTotalWithBoost", 2, 2, true)}%`
            }
            position = "right-bottom"
            renderContent = {
                () => {
                    return ( <
                        >
                        <
                        StatsTooltipRow label = "Escrowed $ZOMI APR"
                        showDollar = {
                            false
                        }
                        value = {
                            `${formatKeyAmount(processedData, "gmxAprForEsGmx", 2, 2, true)}%`
                        }
                        /> {
                            (!processedData.gmxBoostAprForNativeToken ||
                                processedData.gmxBoostAprForNativeToken.eq(0)) && ( <
                                StatsTooltipRow label = {
                                    `${nativeTokenSymbol} APR`
                                }
                                showDollar = {
                                    false
                                }
                                value = {
                                    `${formatKeyAmount(processedData, "gmxAprForNativeToken", 2, 2, true)}%`
                                }
                                />
                            )
                        } {
                        ...
                        <
                        Trans >
                        APRs are updated weekly on Wednesday and will depend on the fees collected
                        for the week. <
                        /Trans> <
                        /div> <
                        />
            ...
            renderContent = {
                () => {
                    return ( <
                        ...
                        /> <
                        StatsTooltipRow label = "Escrowed $ZOMI"
                        value = {
                            `${formatKeyAmount(
                              processedData,
            ...
            renderContent = {
                () => {
                    return ( <
                        ...
                        br / >
                        <
                        Trans > Use the "Compound"
                        button to stake your Multiplier Points. < /Trans> <
                        /div>
                    );
                }
            }
            ...
            div className = "App-card-row" >
                ...
                <
                Link className = "App-button-option App-card-option"
            to = "/buy_ZOMI" >
                <
                ...
                <
                div className = "App-card-title" > $ZLP({
                    chainName
                }) < /div> <
                div className = "App-card-divider" > < /div> <
                div className = "App-card-content" >
                ...
                /div> <
                div > {
                    formatKeyAmount(processedData, "glpBalance", GLP_DECIMALS, 2, true)
                }
            $ZLP($ {
            ...
            renderContent = {
                () => {
                    return ( <
                        ...
                        value = {
                            `${formatKeyAmount(processedData, "glpAprForNativeToken", 2, 2, true)}%`
                        }
                        showDollar = {
                            false
                        }
                        ...
                        StatsTooltipRow label = "Escrowed $ZOMI APR"
                        value = {
                            `${formatKeyAmount(processedData, "glpAprForEsGmx", 2, 2, true)}%`
                        }
                        showDollar = {
                            false
                        }
            ...
            div className = "App-card-row" >
                ...
                Tooltip
            handle = {
                `$${formatKeyAmount(processedData, "totalGlpRewardsUsd", USD_DECIMALS, 2, true)}`
            }
            position = "right-bottom"
            renderContent = {
                () => {
            ...
            div className = "App-card-divider" > < /div> <
                ...
                /div> <
                div > {
                    formatKeyAmount(processedData, "glpSupply", 18, 2, true)
                }
            $ZLP($ {
            ...
            to = "/buy_mlp#redeem" >
                ...
                /div> <
                div > {
                    formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)
                }
            esZOMI($ {
                ...
                /div> <
                div > {
                    formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)
                }
            esZOMI($ {
            ...
            div className = "App-card-row" >
                ...
                /div> <
                div > {
                    formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)
                }
            esZOMI($ {
                ...
                /div> <
                div > {
                    formatAmount(esGmxSupply, 18, 0, true)
                }
            esZOMI($ {
            ...
            renderContent = {
                () => {
                    return ( <
                        ...
                        value = {
                            formatAmount(processedData.bnGmxInFeeGmx, 18, 2, true)
                        }
                        /> <
                        />
                    );
            ...
            renderContent = {
                () => {
                    return ( <
                        ...
                        tokens have been converted to $ZOMI from the {
                            " "
                        } {
            ...
            div className = "App-card-row" >
                ...
                Tooltip
            handle = {
                `${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} $ZOMI`
            }
            position = "right-bottom"
            renderContent = {
                () => ( <
            ...
            /div> <
            div className = "App-card-divider" > < /div> <
                div className = "App-card-options" > {!active && ( <
                        button className = "App-button-option App-card-option"
                        onClick = {
                            () => connectWallet()
                        } >
            ...
            div className = "App-card-row" >
                ...
                Tooltip
            handle = {
                `${formatKeyAmount(vestingData, "glpVesterClaimSum", 18, 4, true)} / ${formatKeyAmount(
                        vestingData,
            ...
            div className = "App-card-row" >
                ...
                Tooltip
            handle = {
                `${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} $ZOMI`
            }
            position = "right-bottom"
            renderContent = {
                () => ( <
