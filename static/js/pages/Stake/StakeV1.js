        ...
        contract
            ...
            .then(async (res) => {
                ...
                helperToast.success( <
                    ...
                    <
                    Trans >
                    Stake submitted! < ExternalLink href = {
                        txUrl
                    } > View status. < /ExternalLink> <
                    /Trans> <
                    br / >
                    <
                    /div>
        ...
        contract
            ...
            .then(async (res) => {
                ...
                helperToast.success( <
                    ...
                    <
                    Trans >
                    Unstake submitted! < ExternalLink href = {
                        txUrl
                    } > View status. < /ExternalLink> <
                    /Trans> <
                    br / >
...
export default function StakeV1() {
    ...
    const {
        data: totalStakedInfo,
        mutate: updateTotalStakedInfo
    } = useSWR(
    ...
    const {
        balanceData,
        supplyData
    } = getBalanceAndSupplyData(balances);
        ...
        contract
            ...
            .then(async (res) => {
                ...
                helperToast.success( <
                    ...
                    <
                    Trans >
                    Claim submitted! < ExternalLink href = {
                        txUrl
                    } > View status. < /ExternalLink> <
                    /Trans> <
                    br / >
    ...
    return ( <
        ...
        USDG tokens will
        continue to
        function as before and do not need to be migrated. <
            /Trans> <
            /div> <
        ...
        /Link> {
            active && ( <
                ...
                onClick = {
                    () => claim(usdgAddress, processedData.usdgRewards)
                } >
                <
                Trans > Claim < /Trans> <
                /button>
        ...
        div className = "App-card-options" >
        <
        ExternalLink className = "App-button-option App-card-option"
        href = {
            buyXgmtUrl
        } >
        Get xGMT <
        /ExternalLink> {
            active && ( <
                button className = "App-button-option App-card-option"
                onClick = {
                    () => claim(xgmtAddress, processedData.xgmtRewards)
                } >
                <
                Trans > Claim < /Trans> <
                /button>
        ...
        div > {
            ...
            formatKeyAmount(processedData, "gmtUsdgXgmtRewards", 18, 4, true)
        }
        xGMT <
        /div> <
        /div> <
        ...
        div > {
            ...
            formatKeyAmount(processedData, "xgmtUsdgXgmtRewards", 18, 4, true)
        }
        xGMT <
        /div> <
        /div> <
        ...
        /ExternalLink> {
            ...
            active && ( <
                button className = "App-button-option App-card-option"
                onClick = {
                    () => claim(xgmtUsdgFarmAddress, processedData.xgmtUsdgTotalRewards)
                } >
                <
                Trans > Claim < /Trans> <
                /button>
        ...
        /div> <
        div > {
            formatKeyAmount(processedData, "autoUsdgXgmtRewards", 18, 4, true)
        }
        xGMT < /div> <
        /div> <
        div className = "Stake-info App-card-row" >
        ...
        /ExternalLink> {
            ...
            active && ( <
                button className = "App-button-option App-card-option"
                onClick = {
                    () => claim(autoUsdgFarmAddress, processedData.autoUsdgTotalRewards)
                } >
                <
                Trans > Claim < /Trans> <
                /button>
