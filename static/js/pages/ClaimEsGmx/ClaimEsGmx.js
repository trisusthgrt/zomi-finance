    ...
    return ( <
        ...
        /div> {
            !isArbitrum && ( <
                ...
                <
                Trans > Please
                switch your network to Arbitrum. < /Trans> <
                /div>
            )
        } {
            isArbitrum && ( <
                ...
                <
                Trans > You have {
                    formatAmount(esGmxIouBalance, 18, 2, true)
                }
                esZOMI(IOU) tokens. < /Trans> <
                br / >
                <
                br / >
                <
                Trans > The address of the esZOMI(IOU) token is {
                    esGmxIouAddress
                }. < /Trans> <
                br / >
                <
                Trans >
                The esZOMI(IOU) token is transferrable.You can add the token to your wallet and send it to another address to claim
                if you 'd like. <
                /Trans> <
                br / >
                <
                ...
                <
                Trans >
                After claiming, the esZOMI tokens will be airdropped to your account on the selected network within 7 days. <
                /Trans> <
                br / >
                <
                ...
                ExternalLink href = {
                    `https://arbiscan.io/token/${esGmxIouAddress}?a=${account}`
                } > here < /ExternalLink>. <
                /Trans> <
                /div> <
                br / >
                ...
                <
                Checkbox className = "arbitrum btn btn-primary btn-left btn-lg"
                isChecked = {
                    selectedOption === VEST_WITH_GMX_ARB
                }
                setIsChecked = {
                    () => setSelectedOption(VEST_WITH_GMX_ARB)
                } >
                <
                ...
                setIsChecked = {
                    () => setSelectedOption(VEST_WITH_GLP_ARB)
                } >
                <
                div className = "ClaimEsGmx-option-label" >
                <
                ...
                <
                /Checkbox> <
                Checkbox className = "avalanche btn btn-primary btn-left btn-lg"
                isChecked = {
                    selectedOption === VEST_WITH_GMX_AVAX
                }
                setIsChecked = {
                    () => setSelectedOption(VEST_WITH_GMX_AVAX)
                } >
                <
                div className = "ClaimEsGmx-option-label" >
                <
                ...
                Checkbox className = "avalanche btn btn-primary btn-left btn-lg"
                isChecked = {
                    selectedOption === VEST_WITH_GLP_AVAX
                }
                setIsChecked = {
                    () => setSelectedOption(VEST_WITH_GLP_AVAX)
                } >
                <
                ...
                br / > {!error && ( <
                        ...
                        You can currently vest a maximum of {
                            formatAmount(maxVestableAmount, 18, 2, true)
                        }
                        esZOMI tokens at a ratio of {
                            formatAmount(currentRatio, 4, 2, true)
                        } {
                            stakingToken
                        }
                        to 1 esZOMI. <
                        ...
                        After claiming you will be able to vest a maximum of {
                            formatAmount(nextMaxVestableEsGmx, 18, 2, true)
                        } {
                            " "
                        }
                        esZOMI at a ratio of {
                            formatAmount(nextRatio, 4, 2, true)
                        } {
                            stakingToken
                        }
                        to 1 esZOMI. <
                ...
                /> {
                    value !== formatAmountFree(esGmxIouBalance, 18, 18) && ( <
                        div className = "ClaimEsGmx-max-button"
                        onClick = {
                            () => setValue(formatAmountFree(esGmxIouBalance, 18, 18))
                        } >
                        <
                        Trans > MAX < /Trans> <
                        /div>
