...
import {
    HeaderLink
} from "components/Header/HeaderLink";
import {
    ARBITRUM,
    MAINNET
} from "config/chains";
...
export default function Home({
    ...
    const LaunchExchangeButton = () => {
        return ( <
            HeaderLink className = "default-btn"
            to = "/trade"
            redirectPopupTimestamp = {
                redirectPopupTimestamp
            }
    ...
    return ( <
        div className = "Home" >
        <
        div className = "Home-top" > { /* <div className="Home-top-image"></div> */ } <
        ...
        <
        Trans >
        Trade BTC, ETH, AVAX and other top cryptocurrencies with up to 30 x leverage directly from your wallet <
        /Trans> <
        /div> <
        ...
        /div> { /* <div className="Home-latest-info__value">${formatAmount(totalVolume, USD_DECIMALS, 0, true)}</div> */ } <
        ...
        /div> { /* <div className="Home-latest-info__value">${formatAmount(openInterest, USD_DECIMALS, 0, true)}</div> */ } <
        div className = "Home-latest-info__value" > {
