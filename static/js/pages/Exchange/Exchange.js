...
export const Exchange = forwardRef((props, ref) => {
            ...
            const {
                data: tokenBalances
            } = useSWR(active && [active, chainId, readerAddress, "getTokenBalances", account], {
          ...
          true
            ...
            const renderCancelOrderButton = () => {
                ...
                return ( <
                    button className = "muted font-base cancel-order-btn"
                    disabled = {
            ...
            const getListSection = () => {
                return ( <
                    ...
                    optionLabels = {
                        LIST_SECTIONS_LABELS
                    }
                    option = {
                        listSection
                    }
                    onChange = {
                        (section) => setListSection(section)
                    }
                    type = "inline"
                    ...
                    /div> {
                        listSection === POSITIONS && ( <
                            PositionsList positionsDataIsLoading = {
            ...
            const renderChart = () => {
                return ( <
                    ExchangeTVChart fromTokenAddress = {
                        fromTokenAddress
                    }
                    toTokenAddress = {
                        toTokenAddress
            ...
            return ( <
                div className = "Exchange page-layout" > {
                    showBanner && < ExchangeBanner hideBanner = {
                        hideBanner
                    }
                    />} <
