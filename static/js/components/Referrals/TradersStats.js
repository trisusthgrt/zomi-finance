...
function TradersStats({
    ...
    return ( <
        ...
        tooltipText = {
            t `Volume traded by this account with an active referral code.`
        }
        data = {
        ...
        tooltipText = {
            t `Rebates earned by this account as a trader.`
        }
        data = {
        ...
        data = { <
            ...
            /div> {
                traderTier && ( <
                    ...
                    <
                    Tooltip handle = {
                        t `Tier ${getTierIdDisplay(traderTier)} (${tierDiscountInfo[traderTier]}% discount)`
                    }
                    ...
                    renderContent = {
                        () => ( <
                            ...
                            Trans >
                            You will receive a {
                                tierDiscountInfo[traderTier]
                            } % discount on your opening and closing fees,
        ...
        <
        ReferralCodeForm userReferralCodeString = {
            userReferralCodeString
        }
        setPendingTxns = {
            setPendingTxns
        ...
        /div> {
            referralsData ? .discountDistributions.length > 0 ? ( <
                ...
                <
                Card title = {
                    t `Rebates Distribution History`
                }
                tooltipText = {
