    ...
    function getModalContent(modalName) {
        switch (modalName) {
            case LANGUAGE_MODAL_KEY:
                return <LanguageModalContent currentLanguage = {
                    currentLanguage
                }
                />;
            case NETWORK_MODAL_KEY:
                return ( <
                    NetworkModalContent setActiveModal = {
                        setActiveModal
                    }
                    networkOptions = {
    ...
    return ( <
        > {
            props.small ? ( <
                ...
                DesktopDropdown currentLanguage = {
                    currentLanguage
                }
                activeModal = {
                    activeModal
...
function NavIcons({
    ...
    return ( <
        ...
        <
        button className = {
            cx("btn-primary small transparent")
        } >
        <
        img className = "network-dropdown-icon"
        src = {
            selectorLabel === "Arbitrum" ? arbitrumIcon : ethIcon
        }
        alt = {
            selectorLabel
        }
...
function DesktopDropdown({
    ...
    return ( <
        ...
        <
        NetworkMenuItems networkOptions = {
            networkOptions
        }
        selectorLabel = {
            selectorLabel
        ...
        Menu.Item >
        <
        div className = "network-dropdown-menu-item menu-item last-dropdown-menu"
        onClick = {
...
function LanguageModalContent({
    ...
    return Object.keys(locales).map((item) => {
                ...
                return ( <
                    ...
                    className = {
                        cx("network-dropdown-menu-item  menu-item language-modal-item", {
                    ...
                    <
                    div className = "menu-item-icon" > {
                        isTestLanguage(item) ? "🫐" : < img className = "network-dropdown-icon"
                        src = {
                            image
                        }
                        alt = {
                        ...
                        /div> <
                        div className = "network-dropdown-menu-item-img" > {
                            currentLanguage.current === item && < img src = {
                                checkedIcon
                            }
                            alt = {
                                locales[item]
            ...
            function NetworkModalContent({
                ...
                return ( <
                    ...
                    div className = "menu-item-group" >
                    <
                    img className = "network-option-img"
                    src = {
                        language24Icon
                    }
                    alt = "Select Language" / >
