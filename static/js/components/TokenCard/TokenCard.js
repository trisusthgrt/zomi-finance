...
export default function TokenCard({
    ...
    return ( <
        ...
        /div> <
        div className = "Home-token-card-option-apr" > { /* <Trans>Arbitrum APR:</Trans> <APRLabel chainId={ARBITRUM} label="gmxAprTotal" />,{" "} */ } <
        ...
        /BuyLink> <
        /div> <
        ExternalLink href = "https://docs.zomi.financetokenomics/mmx"
        ...
        /div> <
        div className = "Home-token-card-option-apr" > { /* <Trans>Arbitrum APR:</Trans> <APRLabel chainId={ARBITRUM} label="glpAprTotal" key="ARBITRUM" />,{" "} */ } <
        ...
        /BuyLink> <
        /div> <
        a href = "https://docs.zomi.financetokenomics/mlp"
        target = "_blank"
        rel = "noreferrer"
        className = "default-btn read-more" >
        <
