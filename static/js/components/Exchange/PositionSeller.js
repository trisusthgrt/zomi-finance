...
export default function PositionSeller(props) {
    ...
    const renderExistingOrderWarning = useCallback(() => {
        ...
        return ( <
            ...
            You have an active order to decrease {
                ...
                formatAmount(existingOrder.sizeDelta, USD_DECIMALS, 2, true)
            }) at {
                prefix
            } {
                " "
        ...
        if (profitPrice && nextDelta.eq(0) && nextHasProfit) {
            ...
            if (orderOption === MARKET) {
                return ( <
                    ...
                    <
                    Trans >
                    Reducing the position at the current price will forfeit a & nbsp; <
                    ...
                    $ {
                        formatAmount(profitPrice, USD_DECIMALS, 2, true)
                    }.This rule applies
                    for the next {
                        getTimeRemaining(minProfitExpiration)
                    }, until {
            ...
            return ( <
                ...
                <
                Trans >
                This order will forfeit a & nbsp; <
    ...
    return ( <
        div className = "PositionEditor" > {
            position && ( <
                Modal className = "PositionSeller-modal"
                isVisible = {
                    isVisible
                }
                setIsVisible = {
                ...
                /div> {
                        ...
                        renderContent = {
                            () => {
                                return ( <
                                    ...
                                    <
                                    br / >
                                    Note that a low allowed slippage, e.g.less than 0.5 % , may result in failed orders
                    ...
                    orderOption === STOP && ( <
                        ...
                        /div> <
                        div className = "align-right" > {!triggerPriceUsd && "-"
                        } {
                ...
                /div> {
...

                    {
                        isSwapAllowed && receiveToken && ( <
                            ...
                            className = {
                                cx("PositionSeller-token-selector", {
                                    ...
                                    if (isNotEnoughLiquidity) {
                                        ...
                                        return {
                                            ...
                                            message: ( <
                                                div >
                                                <
                                                Trans > Insufficient Available Liquidity to swap to {
                                                ...
                                                <
                                                StatsTooltipRow label = {
                                                    t `Max ${collateralInfo.symbol} in`
                                                }
                                                value = {
                                                    [
                                                ...
                                                <
                                                StatsTooltipRow label = {
                                                    t `Max ${tokenOptionInfo.symbol} out`
                                                }
                                                value = {
                                                    [
