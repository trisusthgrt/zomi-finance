...
export default function PositionsList(props) {
    ...
    return ( <
        ...
        <
        PositionEditor pendingPositions = {
            pendingPositions
        }
        setPendingPositions = {
            setPendingPositions
        ...
        /> {
            ...
            isPositionShareModalOpen && ( <
                PositionShare setIsPositionShareModalOpen = {
            ...
            isPositionSellerVisible && ( <
                PositionSeller pendingPositions = {
                    pendingPositions
                }
                setPendingPositions = {
                    setPendingPositions
                    ...
                    div > {
                        ...
                        positions.map((position) => {
                                    ...
                                    return ( <
                                        ...
                                        /div> <
                                        div > {
                                            formatAmount(position.leverage, 4, 2, true)
                                        }
                                        x & nbsp; <
                                        span className = {
                                            cx("Exchange-list-side", {
                                        ...
                                        div > {
                                            ...
                                            positionOrders.map((order) => {
                                                        ...
                                                        if (order.error) {
                                                            return ( <
                                                                div key = {
                                                                    `${order.isLong}-${order.type}-${order.index}`
                                                                }
                                                                className = "Position-list-order" >
                                                                <
                                                                Tooltip className = "order-error"
                                                                handle = {
                                                                    orderText()
                                                                }
                                                                position = "right-bottom"
                ...
                /tr> {
                    ...
                    positions.map((position) => {
                        ...
                        return ( <
                            ...
                            td >
                            <
                            div > {!position.netValue && t `Opening...`
                            } {
                                position.netValue && ( <
                                    Tooltip handle = {
                                        `$${formatAmount(position.netValue, USD_DECIMALS, 2, true)}`
                            ...
                            div > $ {
                                ...
                                positionOrders.length > 0 && ( <
                                    ...
                                    <
                                    Tooltip handle = {
                                        t `Orders (${positionOrders.length})`
                                    }
                                    position = "left-bottom"
                                    handleClassName = {
                                        cx(
                            ...
                            renderContent = {
                                () => {
                                    return ( <
                                        ...
                                        Trans >
                                        Use the "Close"
                                        button to reduce your position size, or to set stop - loss / take - profit orders. <
                                        /Trans> <
                                        /div>
                                    );
                                }
                            ...
                            td >
                            <
                            button className = "Exchange-list-action"
                            onClick = {
                                () => sellPosition(position)
                            }
                            disabled = {
                            ...
                            td >
                            <
                            PositionDropdown handleEditCollateral = {
                                () => {
                                    editPosition(position);
                                }
                            }
