...
export default function OrdersList(props) {
    ...
    const renderLargeList = useCallback(() => {
                ...
                return orders.map((order) => {
                        if (order.type === SWAP) {
                            ...
                            return ( <
                                ...
                                <
                                Checkbox isChecked = {
                                    cancelOrderIdList ? .includes(orderId)
                                }
                                setIsChecked = {
                                    () => {
                ...
                `
                        ...
                        const orderText = ( <
                            > {
                                order.type === INCREASE ? t `Increase` : t `Decrease`
                            } {
                                indexTokenSymbol
                            } {
                            ...
                            nbsp; by $ {
                                ...
                                error && < div className = "Exchange-list-item-error" > {
                                        error
                                    } < /div>} <
                                    />
                            );
                      ...
                      ${collateralTokenInfo.baseSymbol || collateralTokenInfo.symbol})`
                                ...
                                renderContent = {
                                    () => {
                                        return ( <
                                            Trans >
                                            The price that orders can be executed at may differ slightly from the chart price, as market orders update oracle prices,
                                            while limit / trigger orders do not. <
                                                /Trans>
                                        );
                                    }
                                }
                                ...
                                nbsp; by $ {
                                    ...
                                    renderContent = {
                                        () => {
                                            return ( <
                                                Trans >
                                                The price that the order can be executed at may differ slightly from the chart price as market orders can change the price
                                                while limit / trigger orders cannot. <
                                                /Trans>
                                            );
                                        }
                                    }
