    ...
    const renderSpreadWarning = useCallback(() => {
        ...
        if (spread && spread.isHigh) {
            return ( <
                ...
                1 % , please ensure the trade details are acceptable before comfirming < /Trans> <
                /div>
            );
        }
                        ...
                        ul className = "order-list" > {
                            existingOrders.map((order) => {
                                ...
                                return ( <
                                    ...
                                    <
                                    p > {
                                        type === INCREASE ? t `Increase` : t `Decrease`
                                    } {
                                        indexToken.symbol
                                    } {
...
const renderExecutionFee = useCallback(() => {
    ...
    return ( <
        ExchangeInfoRow label = {
            ...
            formatAmount(executionFee, 18, 4)
        } {
...
const renderMarginSection = useCallback(() => {
            return ( <
                ...
                div > {
                    ...
                    minExecutionFeeErrorMessage && < div className = "Confirmation-box-warning" > {
                        minExecutionFeeErrorMessage
                    } < /div>} {
                        ...
                        ExchangeInfoRow label = {
                            ...
                            Tooltip
                        handle = {
                            `$${formatAmount(collateralAfterFees, USD_DECIMALS, 2, true)}`
                        }
