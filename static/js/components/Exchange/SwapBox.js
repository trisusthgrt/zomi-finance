                ...
                useEffect(() => {
                    ...
                    const renderAvailableLongLiquidity = () => {
                        ...
                        return ( <
                            ...
                            <
                            Tooltip handle = {
                                `$${formatAmount(toTokenInfo.maxAvailableLong, USD_DECIMALS, 2, true)}`
                            }
                                ...
                                () => {
                                    return ( <
                                        ...
                                        StatsTooltipRow label = {
                                            t `Max ${toTokenInfo.symbol} long capacity`
                                        }
                                        value = {
                                        ...
                                        /> <
                                        StatsTooltipRow label = {
                                            t `Current ${toTokenInfo.symbol} long`
                                        }
                                        value = {
                                ...
                                if (anchorOnFromAmount) {
                                    ...
                                    if (toToken) {
                                        const {
                                            ...
                                            toTokenAddress,
                                            infoTokens,
                                            undefined, !isMarketOrder && triggerRatio,
                                            usdgSupply,
                                            totalTokenWeights,
                                            isSwap
                                        );
                        ...
                        return ( <
                            ...
                            /div> {
                                showFromAndToSection && ( <
                                    ...
                                    /> {
                                        shouldShowMaxButton() && ( <
                                            div className = "Exchange-swap-max"
                                            onClick = {
                                                setFromValueToMaximumAvailable
                                            } >
                                            <
                                ...
                                (isLong || isShort) && !isStopOrder && ( <
                                    ...
                                    /div> {
                                        isLeverageSliderEnabled && ( <
                                            div className = {
                                                cx("Exchange-leverage-slider", "App-slider", {
                                                    positive: isLong,
                                                    negative: isShort,
                                                })
                                            } >
                                            ...
                                            handle = {
                                                leverageSliderHandle
                                            }
                                            onChange = {
                                                (value) => setLeverageOption(value)
                                            }
                                            value = {
                                                leverageOption
                                            }
                                        ...
                                        isShort && ( <
                                            ...
                                            onSelectToken = {
                                                onSelectShortCollateralAddress
                                            }
                                            tokens = {
                                                stableTokens
                                            }
                                                    ...
                                                    return ( <
                                                        div > {
                                                            swapFees && ( <
                                                                ...
                                                                is required
                                                                for collateral. < /Trans> <br / >
                                                                <
                                                                br / >
                                                                <
                                                                StatsTooltipRow label = {
                                                                    t `Swap ${fromToken.symbol} to ${collateralToken.symbol} Fee`
                                                                }
                                                                value = {
                                                        ...
                                                        <
                                                        StatsTooltipRow label = {
                                                            t `Position Fee (0.1% of position size)`
                                                        }
                                                        value = {
                                ...
                                isStopOrder && ( <
                                    ...
                                    button on each position row, clicking this will display the option to set trigger orders. < br / >
                                    <
                                    br / >
                                            ...
                                            renderContent = {
                                                () => {
                                                    return ( <
                                                        ...
                                                        <
                                                        StatsTooltipRow label = {
                                                            t `Max ${toTokenInfo.symbol} short capacity`
                                                        }
                                                        value = {
                                                        ...
                                                        /> <
                                                        StatsTooltipRow label = {
                                                            t `Current ${toTokenInfo.symbol} shorts`
                                                        }
                                                        value = {
