                ...
                position && ( <
                    ...
                    /> {
                        (isDeposit || isWithdrawal) && ( <
                            ...
                            /div> <
                            div className = "align-right" > {!nextCollateral && < div > $ {
                                ...
                                /div> <
                                div className = "align-right" > {!nextLeverage && < div > {
                                    ...
                                    x < /div>} {
                                        nextLeverage && ( <
                                            ...
                                            <
                                            /div> {
                                                formatAmount(nextLeverage, 4, 2, true)
                                            }
                                            x <
                                            /div>
                                        )
                                    ...
                                    /div> <
                                    div className = "align-right" > {!nextLiquidationPrice && ( <
                                            div > {!fromAmount && `$${formatAmount(liquidationPrice, USD_DECIMALS, 2, true)}`
                                            } {
                                                fromAmount && "-"
                                            } <
                                            /div>
