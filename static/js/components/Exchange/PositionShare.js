...
function PositionShare({
    ...
    return ( <
        Modal className = "position-share-modal"
        isVisible = {
            isPositionShareModalOpen
        }
        setIsVisible = {
        ...
        <
        PositionShareCard userAffiliateCode = {
            userAffiliateCode
        }
        positionRef = {
            positionRef
        ...
        /> {
            uploadedImageError && < span className = "error" > {
                    uploadedImageError
                } < /span>}
                ...
                <
                button disabled = {!uploadedImageInfo
                }
            ...
            target = "_blank"
            className = {
                cx("tweet-link App-button-option", {
                    disabled: !uploadedImageInfo
                })
            }
            rel = "noreferrer"
    ...
    function PositionShareCard({
        ...
        return ( <
            ...
            li > {
                formatAmount(leverage, 4, 2, true)
            }
            x & nbsp; < /li> <
            li > {
                indexToken.symbol
