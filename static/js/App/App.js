...
import {
    RedirectPopupModal
} from "components/ModalViews/RedirectModal";
import {
...
function FullApp() {
    ...
    return ( <
        ...
        <
        Header disconnectAccountAndCloseSettings = {
        ...
        <
        BeginAccountTransfer setPendingTxns = {
            setPendingTxns
        }
        /> <
        /Route> <
        ...
        <
        CompleteAccountTransfer setPendingTxns = {
            setPendingTxns
        }
        /> <
        /Route> <
        ...
        EventToastContainer / >
        <
        RedirectPopupModal redirectModalVisible = {
        ...
        <
        button className = "Wallet-btn MetaMask-btn"
        onClick = {
            activateMetaMask
        } >
        <
        ...
        /div> <
        /button> <
        button className = "Wallet-btn CoinbaseWallet-btn"
        onClick = {
            activateCoinBase
        } >
        <
        ...
        /div> <
        /button> <
        button className = "Wallet-btn WalletConnect-btn"
        onClick = {
        ...
        onChange = {
            (e) => setSlippageAmount(e.target.value)
        }
        /> <
        ...
        /div> {
            isDevelopment() && ( <
                ...
                setIsChecked = {
                    setShouldDisableValidationForTesting
                } >
                <
